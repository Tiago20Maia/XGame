...
namespace XGame.Interfaces.Repositories.Base
{
    public interface IRepositoryBase<TEntidade, TId>
        where TEntidade : class
        where TId : struct
    {
        IQueryable<TEntidade> ListarPor(Expression<Func<TEntidade, bool>> where, params Expression<Func<TEntidade, bool>>[] includeProperties);

        IQueryable<TEntidade> ListarEOrdenarPor<Tkey>(Expression<Func<TEntidade, bool>> where, Expression<Func<TEntidade, Tkey>> ordem, bool ascendente = true);
        ...
        IQueryable<TEntidade> ListarOrdenarPor<Tkey>(Expression<Func<TEntidade, Tkey>> ordem, bool ascendente = true, params Expression<Func<TEntidade, object>>[] includeProperties);
